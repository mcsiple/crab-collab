---
title: "Leslie Matrix Simulation: Kona Crab"
author: "M Kapur adapted from A Aires da Silva"
date: "2017 April Ongoing"
output:
  html_notebook
---
The final objective of this code is to compute a general stochastic demographic analysis for Kona crabs.
...
source(here("Maia code","miscFunctions.R"))
...
## quick inspection
# params = read.table(paste0("G:/KONA_CRAB/harvest_study/outputs/",Name,"_params.txt"), header = T, sep = ',')
...
lifehist = read.table(paste0("G:/KONA_CRAB/harvest_study/outputs/",Name,"_lifehist.txt"), header = T, sep = ',')
