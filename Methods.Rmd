...
$$
\textbf{N}_{y+1,h} = \textbf{N}_{y,h}*\textbf{A}_h + \textbf{r}_{y,h}
$$
...
$$
Where $\textbf{I}_n$ is an $n$x$n$ identity matrix. When the population is fished, the total mortality is used:
$$
